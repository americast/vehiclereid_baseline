...
#which python3
/nethome/ssinha97/anaconda3.7/bin/python3.7 -u train.py $ImagePath_veri $TrainList_veri -n $num_veri --batch_size 300 --val_step 5 --write-out --start_epoch 0 --backbone resnet50 --save_dir './models/resnet50/' --epochs 200
